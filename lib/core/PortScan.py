...
class Scanner(object):
	...
	def get_http_banner(self, url):
		...
		try:
			r = requests.get(url, headers={'UserAgent':'Mozilla/5.0 (Windows; U; MSIE 9.0; WIndows NT 9.0; en-US))'},
